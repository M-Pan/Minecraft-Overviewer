...
# storage blocks
@material(blockid=238, data=range(3), solid=True)
...
# solar panels
@material(blockid=213, data=range(4), transparent=True, solid=True)
...
# machines
@material(blockid=214, data=range(16), solid=True)
...
# frames
@material(blockid=215, data=range(1), transparent=True, solid=True)
